    ...
    public void onReceiveLocation(BDLocation location) {
        ...
        if(location.getCity()!=null) {
            if (MainActivity.fragment instanceof SimpleFragment) {
                ...
                Handler handler = SimpleFragment.handler;
                handler.sendMessage(msg);
            }
            if (MainActivity.fragment instanceof StandardFragment) {
                MainActivity.mLocClient.stop();
            }
            if (SOSActivity.ActivityStatus != false) {
                Handler handler = SOSActivity.handler;
                Message msg = new Message();
