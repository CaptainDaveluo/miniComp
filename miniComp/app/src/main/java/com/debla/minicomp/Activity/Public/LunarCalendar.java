...
/**
 * Created by Dave-PC on 2017/2/14.
 */
...
public class LunarCalendar {
     ...
     */
    public static final String getLunar(int year,int month,int monthDay){
        String result="";
        int [] idate = new int [4];
        idate = solarToLunar(year,month,monthDay);
        String [] lunarM={"正月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","腊月"};
        String [] lunarD={"初一","初二","初三","初四","初五","初六","初七","初八","初九","初十",
                "十一","十二","十三","十四","十五","十六","十七","十八","十九","二十",
                "廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"
        };
        result=lunarM[idate[1]-1]+lunarD[idate[2]-1];
        Log.e("debug",result);
        return result;
    }
